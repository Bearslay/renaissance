    ...
    class click_matrix : public bengine::click_rectangle {
        protected:
            ...
            void update_adjusted_width() {
                this->adjusted_width = btils::least_common_multiple<int>(this->get_width(), this->cols);
            }
            // \brief Update the matrix's evenHeight
            void update_adjusted_height() {
                this->adjusted_height = btils::least_common_multiple<int>(this->get_height(), this->rows);
            }
