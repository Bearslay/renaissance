...
#ifdef SDL_pixels_h_
HSVRough::HSVRough(const SDL_Color &color) {HSVRough(RGBRough(color));}
...
HSVRough HSVRough::operator+(const HSVRough &color) const {return HSVRough(RGBRough(*this) + RGBRough(color));}
HSVRough HSVRough::operator-(const HSVRough &color) const {return HSVRough(RGBRough(*this) - RGBRough(color));}
HSVRough HSVRough::operator*(const double &scalar) const {return HSVRough(RGBRough(*this) * scalar);}
HSVRough HSVRough::operator/(const double &scalar) const {return HSVRough(RGBRough(*this) / scalar);}
HSVRough HSVRough::operator%(const double &denom) const {return HSVRough(RGBRough(*this) % denom);}
...
#ifdef SDL_pixels_h_
HSVExact::HSVExact(const SDL_Color &color) {HSVExact(RGBExact(color));}
...
HSVExact HSVExact::operator+(const HSVExact &color) const {return HSVExact(RGBExact(*this) + RGBExact(color));}
HSVExact HSVExact::operator-(const HSVExact &color) const {return HSVExact(RGBExact(*this) - RGBExact(color));}
HSVExact HSVExact::operator*(const double &scalar) const {return HSVExact(RGBExact(*this) * scalar);}
HSVExact HSVExact::operator/(const double &scalar) const {return HSVExact(RGBExact(*this) / scalar);}
HSVExact HSVExact::operator%(const double &denom) const {return HSVExact(RGBExact(*this) % denom);}
...
#ifdef SDL_pixels_h_
HSLRough::HSLRough(const SDL_Color &color) {HSLRough(RGBRough(color));}
...
HSLRough HSLRough::operator+(const HSLRough &color) const {return HSLRough(RGBRough(*this) + RGBRough(color));}
HSLRough HSLRough::operator-(const HSLRough &color) const {return HSLRough(RGBRough(*this) - RGBRough(color));}
HSLRough HSLRough::operator*(const double &scalar) const {return HSLRough(RGBRough(*this) * scalar);}
HSLRough HSLRough::operator/(const double &scalar) const {return HSLRough(RGBRough(*this) / scalar);}
HSLRough HSLRough::operator%(const double &denom) const {return HSLRough(RGBRough(*this) % denom);}
...
#ifdef SDL_pixels_h_
HSLExact::HSLExact(const SDL_Color &color) {HSLExact(RGBExact(color));}
...
HSLExact HSLExact::operator+(const HSLExact &color) const {return HSLExact(RGBExact(*this) + RGBExact(color));}
HSLExact HSLExact::operator-(const HSLExact &color) const {return HSLExact(RGBExact(*this) - RGBExact(color));}
HSLExact HSLExact::operator*(const double &scalar) const {return HSLExact(RGBExact(*this) * scalar);}
HSLExact HSLExact::operator/(const double &scalar) const {return HSLExact(RGBExact(*this) / scalar);}
HSLExact HSLExact::operator%(const double &denom) const {return HSLExact(RGBExact(*this) % denom);}
...
#ifdef SDL_pixels_h_
CMYKRough::CMYKRough(const SDL_Color &color) {CMYKRough(RGBRough(color));}
...
#ifdef SDL_pixels_h_
CMYKExact::CMYKExact(const SDL_Color &color) {CMYKExact(RGBExact(color));}
